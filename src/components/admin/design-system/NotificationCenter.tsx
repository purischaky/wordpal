...
function NotificationTypeIcon({ type }: { type: AdminNotification['type'] }) {
  ...
  switch (type) {
    ...
    case 'ai_generation':
      return (
        <svg className={`${iconClass} text-purple-600 dark:text-purple-400`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
    ...
    case 'ai_insight':
      return (
        <svg className={`${iconClass} text-amber-600 dark:text-amber-400`} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
