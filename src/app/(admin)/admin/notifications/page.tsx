...
const TYPE_COLORS: Record<AdminNotification['type'], string> = {
  ...
  ai_generation: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
  system_error: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300',
  ai_insight: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300',
};
