  ...
  // === BEGINNER: Syntax Foundations ===
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        tutorExplanation: 'Sujeto → Verbo → Objeto es el patrón básico del inglés. - "She" (sujeto) hace la acción. - "reads" (verbo) es lo que hace. - "books" (objeto) es lo que lee. - El verbo lleva -s porque "she" es tercera persona singular. - "He" es un distractor - gramaticalmente funcionaría, pero no es la oración objetivo.',
        blocks: [
          ...
          { id: 'l1-e2-4', label: 'He', category: 'subject', isDistractor: true, sourceOrder: 4 },
        ],
      },
      {
        id: 'l1-e3',
        ...
        hint: 'Subject + Verb + Object',
        tutorExplanation: '"They" es plural, así que el verbo queda como "play" (sin -s). - "Watches" es un distractor - significa algo diferente y usa forma singular. - El orden importa: primero Sujeto, luego Verbo, luego Objeto. - "Soccer play they" sería incorrecto en inglés (¡aunque en otros idiomas sí funciona!).',
        blocks: [
          ...
          { id: 'l1-e3-4', label: 'watches', category: 'verb', isDistractor: true, sourceOrder: 4 },
        ],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        tutorExplanation: 'Cuando tienes Objeto y Lugar, el orden es: Sujeto + Verbo + Objeto + Lugar. - El Objeto ("soccer") va justo después del verbo. - El Lugar ("in the park") dice dónde. - "They play in the park soccer" sonaría poco natural.',
        blocks: [
          ...
          { id: 'l2-e2-5', label: 'always', category: 'time', isDistractor: true, sourceOrder: 5 },
        ],
      },
      {
        id: 'l2-e3',
        ...
        hint: 'Subject + Verb + Object + Place',
        tutorExplanation: 'Mismo patrón: Sujeto ("My brother") + Verbo ("eats") + Objeto ("breakfast") + Lugar ("at home"). - "Drinks" es un distractor - gramaticalmente encaja pero no es la oración correcta. - La -s en "eats" es porque "my brother" = he (singular).',
        blocks: [
          ...
          { id: 'l2-e3-5', label: 'drinks', category: 'verb', isDistractor: true, sourceOrder: 5 },
        ],
      },
    ],
  },
    ...
    exercises: [
      {
        ...
        blocks: [
          ...
          { id: 'l3-e1-5', label: 'at school', category: 'place', isDistractor: true, sourceOrder: 5 },
        ],
      },
      {
        id: 'l3-e2',
